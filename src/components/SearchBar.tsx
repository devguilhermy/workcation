    ...
    return (
        <section className="bg-gray-800">
            <div className="flex justify-between p-5">
                ...
                <button
                    className={`inline-flex py-2 pl-3 pr-4 ml-2 rounded-lg  shadow focus:ring ${
                        isFiltersMenuOpen
            ...
            <form className={`${isFiltersMenuOpen ? 'block' : 'hidden'}`}>
                ...
                <div className="p-5 bg-gray-900">
                    <button
                        type="submit"
                        className="block w-full px-4 py-2 font-semibold text-white bg-blue-700 rounded-lg hover:bg-blue-600"
                    >
                        Filter results
                    </button>
                </div>
